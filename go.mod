module github.com/storacha/delegator
...
require (
	...
	github.com/storacha/go-mkdelegation v0.0.0-20250527192244-46e8f53bebee
...
replace github.com/storacha/go-mkdelegation => ../go-mkdelegation
